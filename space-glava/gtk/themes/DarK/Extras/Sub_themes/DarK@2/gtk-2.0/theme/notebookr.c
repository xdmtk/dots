...
gap_start_border={4,0,0,0}
gap_end_file="images/tabhorizgapend.png"
gap_end_border={0,4,0,0}
gap_side=TOP}
image{
function=EXTENSION
state=ACTIVE
...
gap_start_border={0,0,0,4}
gap_end_file="images/tabvertgapend.png"
gap_end_border={0,0,4,0}
gap_side=LEFT}
image{
function=EXTENSION
state=ACTIVE
